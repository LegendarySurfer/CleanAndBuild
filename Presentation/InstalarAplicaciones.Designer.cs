...
{
    partial class InstalarAplicaciones
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label8 = new Label();
            button2 = new Button();
            btn_Instalar = new Button();
            cb_steam = new CheckBox();
            cb_vscode = new CheckBox();
            cb_Eclipse = new CheckBox();
            cb_putty = new CheckBox();
            cb_skype = new CheckBox();
            cb_discord = new CheckBox();
            cb_zoom = new CheckBox();
            cb_gimp = new CheckBox();
            cb_blender = new CheckBox();
            cb_winrar = new CheckBox();
            cb_vlc = new CheckBox();
            cb_opera = new CheckBox();
            cb_firefox = new CheckBox();
            cb_google = new CheckBox();
            label6 = new Label();
            label5 = new Label();
            label4 = new Label();
            label3 = new Label();
            ...
            BarraTitulo.Controls.Add(pictureBox3);
            ...
            pictureBox1.Location = new Point(1178, 9);
            ...
            pictureBox3.Location = new Point(1265, 9);
            ...
            PanelContenedor.Controls.Add(btn_Instalar);
            PanelContenedor.Controls.Add(cb_steam);
            PanelContenedor.Controls.Add(cb_vscode);
            PanelContenedor.Controls.Add(cb_Eclipse);
            PanelContenedor.Controls.Add(cb_putty);
            PanelContenedor.Controls.Add(cb_skype);
            PanelContenedor.Controls.Add(cb_discord);
            PanelContenedor.Controls.Add(cb_zoom);
            PanelContenedor.Controls.Add(cb_gimp);
            PanelContenedor.Controls.Add(cb_blender);
            PanelContenedor.Controls.Add(cb_winrar);
            PanelContenedor.Controls.Add(cb_vlc);
            PanelContenedor.Controls.Add(cb_opera);
            PanelContenedor.Controls.Add(cb_firefox);
            PanelContenedor.Controls.Add(cb_google);
            ...
            label8.Location = new Point(188, 107);
            label8.Name = "label8";
            label8.Size = new Size(568, 37);
            label8.TabIndex = 52;
            label8.Text = "INSTALEMOS ALGUNAS APLICACIONES";
            // 
            // button2
            // 
            ...
            btn_Instalar.Font = new Font("Century Gothic", 10.8F, FontStyle.Regular, GraphicsUnit.Point, 0);
            btn_Instalar.ForeColor = Color.White;
            btn_Instalar.ImageAlign = ContentAlignment.MiddleLeft;
            btn_Instalar.Location = new Point(507, 659);
            btn_Instalar.Margin = new Padding(3, 4, 3, 4);
            btn_Instalar.Name = "btn_Instalar";
            ...
            btn_opciones.Location = new Point(224, 8);
            ...
            button1.Location = new Point(5, 708);
            ...
            // 
            btnInstalarAplicaciones.BackColor = Color.DeepSkyBlue;
            ...
            btnInstalarAplicaciones.UseVisualStyleBackColor = false;
            // 
            // btnAntivirus
            // 
        ...
        private System.Windows.Forms.CheckBox cb_vscode;
        private System.Windows.Forms.CheckBox cb_Eclipse;
        private System.Windows.Forms.CheckBox cb_putty;
        private System.Windows.Forms.CheckBox cb_skype;
        private System.Windows.Forms.CheckBox cb_discord;
        private System.Windows.Forms.CheckBox cb_zoom;
        private System.Windows.Forms.CheckBox cb_gimp;
        private System.Windows.Forms.CheckBox cb_blender;
